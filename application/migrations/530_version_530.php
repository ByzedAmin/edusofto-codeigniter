...
class Migration_Version_530 extends CI_Migration
{
    ...
    public function up()
    {
    	$this->db->query("DROP TABLE IF EXISTS `sit_plan_templete`;
				CREATE TABLE IF NOT EXISTS `sit_plan_templete` (
		...
		$this->db->query("CREATE TABLE `ontime_payment_type` ( `id` INT(11) NOT NULL AUTO_INCREMENT , `name` VARCHAR(255) NOT NULL , `fee_code` VARCHAR(255) NOT NULL , `description` TEXT NULL , `branch_id` INT(11) NOT NULL , `system` TINYINT(4) NOT NULL , `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`id`)) ENGINE = MyISAM;");
