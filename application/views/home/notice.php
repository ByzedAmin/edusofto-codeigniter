                ...
                <div class="row">
                    <div class="col-lg-10">
                        <div class="notice-content-wrap overflow-hidden">
                            ...
                            ?>
                                <div class="" data-toggle="collapse" aria-expanded="false" data-target="#demo<?php echo $i; ?>">
                                ...
                                <img class="img-rounded" src="<?php echo base_url('uploads/frontend/service/' . $value['image']); ?>" height="50"/>  <br> 
