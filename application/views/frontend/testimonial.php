	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> গুরুত্বপূর্ণ লিংক</a>
			</li>
			<?php if (get_permission('frontend_testimonial', 'is_add')) { ?>
				<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
					<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> গুরুত্বপূর্ণ লিংক যোগ করুন </a>
				</li>
			<?php } ?>
		</ul>
		<div class="tab-content">
			...
			<?php if (get_permission('frontend_testimonial', 'is_add')) { ?>
				<div class="tab-pane <?php echo (isset($validation_error) ? 'active' : ''); ?>" id="create">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('url'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
