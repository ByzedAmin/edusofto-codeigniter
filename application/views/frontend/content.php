								...
								<tr>
									...
									<td class="min-w-xs">
										<?php if (get_permission('manage_page', 'is_edit')) { ?>
											<a href="<?php echo base_url('frontend/content/edit/' . $row['id']); ?>" class="btn btn-default btn-circle icon" data-toggle="tooltip" data-original-title="<?php echo translate('edit'); ?>">
