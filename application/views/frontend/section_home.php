			...
			<section class="panel">
				<div class="tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active">
							<a href="#welcome" data-toggle="tab">প্রতিষ্ঠানের ইতিহাস</a>
						</li>
						<li>
							<a href="#teachers" data-toggle="tab">সভাপতির বাণী</a>
						</li>
						<!-- <li>
						...
						<li>
							<a href="#statistics" data-toggle="tab">অধ্যক্ষের বাণী</a>
						</li>
						<li>
							<a href="#cta" data-toggle="tab">ফেইসবুক পেইজ</a>
						</li>
						<li>
							<a href="#options" data-toggle="tab">অপশন</a>
						</li>
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane" id="statistics">
							...
							<div class="headers-line mt-md">  ছাত্র/ছাত্রী তথ্য/রেজাল্ট </div>
									<?php for ($i = 1; $i < 6; $i++) {  ?>
								...
								<div class="form-group">
									<label class="col-md-3 control-label">Widget Url <span class="required">*</span></label>
									<div class="col-md-7">
								...
								<!-- <div class="form-group">
									<label class="col-md-3 control-label">Statistics Type <span class="">*</span></label>
									<div class="col-md-7">
										<?php
							...
							<?php } ?>
							<div class="headers-line mt-md">  E-Book</div>
							<?php for ($i = 6; $i < 11; $i++) {  ?>
								<div class="headers-line mt-md"> <i class="fas fa-th-large"></i> Widget <?php echo $i ?></div>
								<div class="form-group">
									<label class="col-md-3 control-label">Widget Title <span class="required">*</span></label>
							...
							<?php } ?>
							<div class="headers-line mt-md">  Download</div>
							<?php for ($i = 11; $i < 16; $i++) {  ?>
								<div class="headers-line mt-md"> <i class="fas fa-th-large"></i> Widget <?php echo $i ?></div>
								<div class="form-group">
									<label class="col-md-3 control-label">Widget Title <span class="required">*</span></label>
							...
							<?php } ?>
							<div class="headers-line mt-md">  Notice</div>
							<?php for ($i = 16; $i < 22; $i++) {  ?>
								<div class="headers-line mt-md"> <i class="fas fa-th-large"></i> Widget <?php echo $i ?></div>
								<div class="form-group">
									<label class="col-md-3 control-label">Widget Title <span class="required">*</span></label>
						...
						<div class="tab-pane" id="cta">
							...
							<!-- <div class="form-group">
								<label class="col-md-3 control-label"><?php echo translate('button_text'); ?> <span class="">*</span></label>
								<div class="col-md-7">
							...
							<div class="form-group">
								<label class="col-md-3 control-label"><?php echo translate('button_url'); ?> <span class="">*</span></label>
								<div class="col-md-7">
