<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('frontend/services'); ?>"><i class="fas fa-list-ul"></i> <?php echo translate('notice') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
				<a href="#edit" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('edit') . " " . translate('notice'); ?></a>
			</li>
		</ul>
			...
			<div class="tab-pane active" id="edit">
				<?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit-data')); ?>
					...
					<div class="form-group <?php if (form_error('description')) echo 'has-error'; ?>">
						...
						<div class="col-md-6">
							<textarea class="form-control summernote" id="description" name="description" placeholder="" rows="3" ><?php echo set_value('description', $services['description']); ?></textarea>
							<span class="error"></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="hidden" name="old_photo" value="<?php echo $services['image']; ?>">
							<input type="file" name="photo" class="dropify" data-height="150" data-default-file="<?php echo base_url('uploads/frontend/service/' . $services['image']); ?>" />
							<span class="error"></span>
						</div>
					</div>
