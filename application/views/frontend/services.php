	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			...
			<?php if (get_permission('frontend_services', 'is_add')) { ?>
				<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
					<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('add') . " " . translate('notice'); ?></a>
				</li>
			<?php } ?>
		</ul>
					...
					<tbody>
						...
						?>
								<tr>
									...
									<td><img class="img-rounded" src="<?php echo base_url('uploads/frontend/service/' . $row['image']); ?>" height="50"/></td>
			...
			<?php if (get_permission('frontend_services', 'is_add')) { ?>
				<div class="tab-pane <?php echo (isset($validation_error) ? 'active' : ''); ?>" id="create">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<textarea class="summernote"  name="description"><?php echo set_value('description'); ?></textarea>
							<span class="error"></span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('photo'); ?> <span class=""></span></label>
						<div class="col-md-4">
