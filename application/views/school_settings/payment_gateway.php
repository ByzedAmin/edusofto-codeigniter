                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane box" id="bkash">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="bkash_app_key" value="<?=$config['bkash_app_key']?>">
                                <span class="error"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-3 control-label">bKash Secret Key</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="bkash_secret_key" value="<?=$config['bkash_secret_key']?>">
                                <span class="error"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="bkash_username" value="<?=$config['bkash_username']?>">
                                <span class="error"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="bkash_password" value="<?=$config['bkash_password']?>">
                                <span class="error"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-offset-3 col-md-6 mb-md">
                                <div class="checkbox-replace">
                                    <label class="i-checks">
                                        <input type="checkbox" name="bkash_sandbox" id="bkash_sandbox" <?=($config['bkash_sandbox'] == 1 ? 'checked' : ''); ?>>
                                        <i></i> bKash Sandbox
                                    </label>
                                </div>
                            </div>
