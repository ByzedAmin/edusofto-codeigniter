<header class="header">
	<div class="logo-env">
	<?php 
		$branch_img = $this->db->where('id',1)->get('branch')->row_array();
	?>
		<a href="<?php echo base_url('dashboard');?>" class="logo">
		<?php if(!empty($branch_img['text_logo'])){ ?>
			<img src="<?=base_url('uploads/app_image/'.$branch_img['text_logo'])?>" height="40">
		<?php }else{ ?>
	...
	<div class="header-right">
		<ul class="header-menu">
			<li>
				<a href="https://www.youtube.com/watch?v=qKBBbNmPA3U&list=PLKgRNQjQpLGs3mEUz7hDL7hu5Prsin-cM" target="_blank" class="btn btn-success"
				data-original-title="<?php echo translate('show_tutorial'); ?>">
				ভিডিও টিউটোরিয়াল
				</a>
			</li>
		<?php 
