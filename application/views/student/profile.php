		...
		<div class="panel-group" id="accordion">
				...
				<div id="profile" class="accordion-body collapse <?=($this->session->flashdata('profile_tab') == 1 ? 'in' : ''); ?>">
					...
					<div class="panel-body">
						...
						<div class="headers-line">
							...
							<!-- update link -->
							<a target="_blank" href="<?php echo base_url('parents/profile/' . $student['parent_id']);?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
									data-original-title="<?=translate('edit_parent_profile')?>">
									<i class="far fa-arrow-alt-circle-right"></i>Edit Parent Profile
								</a>
						</div>
						<div class="row mb-md">
			...
			<div class="panel panel-accordion">
				<div class="panel-heading">
					<h4 class="panel-title">
						<div class="auth-pan">
                            <a target="_blank" style="padding: 4px !important" href="<?php echo base_url('parents/profile/' . $student['parent_id']);?>" class="btn btn-default btn-circle">
								<i class="far fa-arrow-alt-circle-right"></i> <?=translate('edit_parent_profile')?>
                            </a>
                        </div>
