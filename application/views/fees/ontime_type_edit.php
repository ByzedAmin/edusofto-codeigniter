			...
			<div class="tab-pane active" id="create">
				...
				<input type="hidden" name="voucher_type" value="expense">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="ontime_type_name" value="<?=$category['name']?>" />
							<span class="error"></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 mb-md">
							<textarea class="form-control" id="description" name="ontime_description" placeholder="" rows="3"><?=$category['description']?></textarea>
						</div>
					</div>
