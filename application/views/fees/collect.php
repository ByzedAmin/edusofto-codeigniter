								...
								<tbody>
									...
									<tr>
										<td class="hidden-print checked-area">
											<div class="checkbox-replace">
												<label class="i-checks"><input type="checkbox" name="cb_invoice" value="<?php echo $row['amount']; ?>" data-allocation-id="<?php echo $row['allocation_id'] ?>" data-fee-type-id="<?php echo $row['fee_type_id'] ?>"><i></i></label>
											</div>
										</td>
				...
				<div id="onetime_payment" class="tab-pane">
					<?php echo form_open('fees/ontime_payment', array('class' => 'form-horizontal frm-submit' )); ?>
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><?=translate('amount')?> <span class="required">*</span></label>
							<div class="col-md-6">
								<input type="text" class="form-control" name="amount" id="feeAmount" autocomplete="off" />
								<span class="error"></span>
							</div>
						</div>
						<div class="form-group">
