                    ...
                    <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding fitxt-center">
                        ...
                        <div class="content">
                            ...
                            <div class="center img-hol-p">
                                <img src="<?=base_url('uploads/app_image/'.$branch_img['logo_file'])?>" height="60" alt="School">
                            </div>
                            <div class="address">
                    ...
                    <div class="col-lg-6 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
                        <div class="sign-area">
                            <div class="sign-hader">
                                <img src="<?=base_url('uploads/app_image/'.$branch_img['logo_file'])?>" height="54" alt="">
        ...
        <script>
            (function($) {
                ...
                $(document).ready(function() {
                    $.backstretch([
                        base_url + "<?='uploads/frontend/images/'.$global_config['slider_1']?>",
                        base_url + "<?='uploads/frontend/images/'.$global_config['slider_2']?>",
                        base_url + "<?='uploads/frontend/images/'.$global_config['slider_3']?>",
