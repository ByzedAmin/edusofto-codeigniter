				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="file" name="logo_file" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['global_logo'])?>" />
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label class="control-label"><?=translate('text_logo');?></label>
							<input type="file" name="text_logo" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['text_logo'])?>" />
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label class="control-label"><?=translate('printing_logo');?></label>
							<input type="file" name="print_file" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['print_file'])?>" />
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label class="control-label"><?=translate('report_card');?></label>
							<input type="file" name="report_card" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['report_card'])?>" />
						</div>
					</div>
				</div>
				...
				<div class="row mb-ld">
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="file" name="slider_1" class="dropify" data-allowed-file-extensions="jpg" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['slider_1'])?>" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">Slider 2</label>
							<input type="file" name="slider_2" class="dropify" data-allowed-file-extensions="jpg" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['slider_2'])?>" />
						</div>
					</div>
					<div class="col-md-4 mb-lg">
						<div class="form-group">
							<label class="control-label">Slider 3</label>
							<input type="file" name="slider_3" class="dropify" data-allowed-file-extensions="jpg" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['slider_3'])?>" />
						</div>
					</div>
				</div>
				<!-- Other background -->
				...
				<div class="row mb-ld">
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="file" name="sidebox_1" class="dropify" data-allowed-file-extensions="jpg" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['sidebox_1'])?>" />
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="file" name="profile_bg" class="dropify" data-allowed-file-extensions="jpg" data-default-file="<?=base_url('uploads/frontend/images/'.$global_config['profile_bg'])?>" />
						</div>
					</div>
				</div>
