	...
	<div class="col-md-12">
				...
				<?php endif; ?>
					...
					<div class="col-md-<?=$widget?> mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayClass = $this->app_lib->getSelectByBranch('sit_plan_templete', $branch_id, false, array('user_type' => 1, 'card_type' => 1));
		...
		<?php if (isset($stuList)): ?>
			<section class="panel appear-animation" data-appear-animation="<?php echo $global_config['animations']?>" data-appear-animation-delay="100">
				<?php echo form_open('card_manage/sitPlanprintFn/1', array('class' => 'printIn')); ?>
