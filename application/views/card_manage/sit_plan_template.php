...
<?php if (get_permission('id_card_templete', 'is_add')): ?>
			<li>
                <a href="#add" data-toggle="tab">
                   <i class="far fa-edit"></i> <?=translate('add') . " ". translate('sit_plan')?>
                </a>
			</li>
<?php endif; ?>
		</ul>
...
<?php endif; ?>
							...
							<td class="min-w-c">
								...
								onclick="getSitPlan('<?=$row['id'] ?>');">
									<i class="fas fa-bars"></i>
								</a>
							<?php if (get_permission('id_card_templete', 'is_edit')) { ?>
								<a href="<?=base_url('card_manage/sit_plan_templete_edit/' . $row['id']);?>" class="btn btn-circle btn-default icon">
									<i class="fas fa-pen-nib"></i>
								</a>
							<?php } if (get_permission('id_card_templete', 'is_delete')) { ?>
								<!-- deletion link -->
								<?php echo btn_delete('card_manage/sit_plan_delete/'.$row['id']);?>
							<?php } ?>
							</td>
						</tr>
						<?php endforeach; ?>
...
<?php if (get_permission('id_card_templete', 'is_add')): ?>
			<div class="tab-pane" id="add">
					...
					<?php endif; ?>
					<div class="form-group">
						<label class="col-md-3 control-label"><?=translate('sit_plan') . " " . translate('name')?> <span class="required">*</span></label>
						<div class="col-md-8">
