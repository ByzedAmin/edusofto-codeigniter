							...
							<table class="table table-bordered table-hover table-condensed mb-none">
								...
								<tbody>
									...
									<tr>
											...
											if (!empty($getMark)) {
												if ($getMark['absent'] != 'on') {
													...
													foreach ($fullMarkDistribution as $i => $val) {
														...
														$totalObtainedM += $obtained_mark;
														$totalFullMarkM += $val['full_mark'];
													...
													if ($totalObtainedM != 0 && !empty($totalObtainedM)) {
												...
												$totalFullmarksM += $totalFullMarkM;
										...
										?>
										<?php endforeach; 
										$arrayTotal[] = $totalMarksM;
										
										// print_r($totalMarksM);
										?>
										<!-- <?php echo form_open('exam/merit_list_save', array('class' => 'validate')); ?>
											<input type="text" value="<?php echo $totalMarksM ?>" name="total_mark[]">
										...
										<?php
											if ($unset_subject == 0) {
												...
												if ($result_status) {
													...
													$tota_cgpa =  $tota_cgpa-$subject['cut_point'];
