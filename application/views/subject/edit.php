		...
		<div class="tab-content">
			<div id="edit" class="tab-pane active">
				...
				<input type="hidden" name="subject_id" value="<?=$subject['id']?>">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">
							<?=translate('addition_subject_code')?>
						</label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="add_subject_code" value="<?=$subject['add_subject_code']?>" />
							<span class="error">শুধু মাত্র প্রথম এবং দ্বিতীয় পত্র থাকলে প্রযোজ্য</span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="sub_mark" value="<?=$subject['sub_mark']?>" />
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="cut_point" value="<?=$subject['cut_point']?>" />
							<span class="error">যদি সাবজেক্ট ঐচিছক হয়</span>
						</div>
					</div>
