...
<?php if (get_permission('subject', 'is_add')): ?>
			<div class="tab-pane" id="create">
				<?php echo form_open('subject/save', array('class' => 'form-horizontal form-bordered frm-submit'));?>
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?=translate('addition_subject_code')?></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="add_subject_code" />
							<span class="error"></span>
							<span style="color:red">শুধু মাত্র প্রথম এবং দ্বিতীয় পত্র থাকলে প্রযোজ্য</span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"><?=translate('sub_mark')?></label>
						<div class="col-md-6">
							<input type="number" class="form-control" name="sub_mark" />
							<span class="error">শুধুমাত্র প্রথম পত্রের জন্য প্রযোজ্য</span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"><?=translate('cut_point') ?></label>
						<div class="col-md-6">
							<input type="number" class="form-control" name="cut_point" />
							<span class="error" style="color: red;">যদি সাবজেক্ট ঐচিছক হয়</span>
						</div>
					</div>
