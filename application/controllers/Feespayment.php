...
class Feespayment extends Admin_Controller
{
    ...
    public function bkash()
    {
        ...
        if (!empty($params)) {
            if ($config['bkash_username'] == "" || $config['bkash_password'] == "" || $config['bkash_app_key'] == "" || $config['bkash_secret_key'] == "") {
                ...
                $data = array(
                    ...
                    'token_url' => base_url('feespayment/bkash_token'),
                    'checkout_url' => base_url('feespayment/bkash_checkout'),
                    'execute_url' => base_url('feespayment/bkash_execute'),
                    'success_url' => base_url('feespayment/bkash_success'),
                );
            ...
            try {
                ...
                if (isset($response['transactionStatus']) && $response['transactionStatus'] == 'Completed') {
                    ...
                    $arrayFees = array(
                        ...
                        'pay_via' => 15,
                        'collect_by' => 'online',
                        'remarks' => "Fees deposits online via Bkash Ref ID: " . $ref_id,
                        'date' => date("Y-m-d"),
                    );
                    $this->savePaymentData($arrayFees);
