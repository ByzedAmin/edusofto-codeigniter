...
class Frontend_model extends MY_Model
{
    ...
    public function save_services($data)
    {
        $services_data = array(
            ...
            'description' => $data['description'],
            'icon' => $data['icon'],
            'image' => $this->upload_service_image(),
        );
      ...
      public function upload_service_image()
      {
          ...
          $return_image = '';
          if ($image != '') {
              $destination = './uploads/frontend/service/';
              $extension = pathinfo($image, PATHINFO_EXTENSION);
              $image_path = 'home-service-' . time().date('md') . '.' . $extension;
      ...
      {
          $path = 'uploads/frontend/service/' . $file_path;
